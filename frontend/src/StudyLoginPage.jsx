    ...
    return (
        ...
        <div className="bg-white p-5 shadow rounded border-top border-primary border-5" style={{ width: '400px' }}>
            <h2 className ="text-center mb-4 text-primary fw-bold">
                {isRegistering ? "Create Account" : "PlannerLogin"}
            </h2>
            <input type="text" placeholder="Username" className="from-control mb-4" onClick={(e) => setUsername(e.target.value)}/>
            <input type="password" placeholder="Password" className="from-control mb-4" onChange={(e) => setPassword(e.target.value)}/>
